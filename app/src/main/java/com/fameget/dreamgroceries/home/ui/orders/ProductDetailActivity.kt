...
import com.fameget.dreamgroceries.databinding.ActivityProductDetailBinding
...
class ProductDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = com.fameget.dreamgroceries.databinding.ActivityProductDetailBinding.inflate(
            layoutInflater
        )
